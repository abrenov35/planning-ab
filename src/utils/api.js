...
export const createChantier=async(nom,dateDebut,dateFin,description)=>appeler({action:"createChantier",nom,dateDebut,dateFin,description:description||""});
...
export const updateChantier=async(id,nom,dateDebut,dateFin,description,statut)=>appeler({action:"updateChantier",id,nom:nom||"",dateDebut:dateDebut||"",dateFin:dateFin||"",description:description||"",statut:statut||""});
