...
export const createChantier=async(nom,dateDebut,dateFin,description,couleur="")=>appeler({action:"createChantier",nom,dateDebut,dateFin,description:description||"",couleur:couleur||""});
...
export const updateChantier=async(id,nom,dateDebut,dateFin,description,statut,couleur="")=>appeler({action:"updateChantier",id,nom:nom||"",dateDebut:dateDebut||"",dateFin:dateFin||"",description:description||"",statut:statut||"",couleur:couleur||""});
