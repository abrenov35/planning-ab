...
export const createChantier=async(nom,dateDebut,dateFin,description,couleur="",dateSignature="")=>appeler({action:"createChantier",nom,dateDebut,dateFin,description:description||"",couleur:couleur||"",dateSignature:dateSignature||""});
export const updateOuvrier=async(id,nom,type,metier,statut,ordre="",separateurApres=false)=>appeler({action:"updateOuvrier",id,nom:nom||"",type:type||"",metier:metier||"",statut:statut||"",ordre:ordre===""?"":String(ordre),separateurApres:separateurApres?"TRUE":"FALSE"});
export const updateChantier=async(id,nom,dateDebut,dateFin,description,statut,couleur="",dateSignature="")=>appeler({action:"updateChantier",id,nom:nom||"",dateDebut:dateDebut||"",dateFin:dateFin||"",description:description||"",statut:statut||"",couleur:couleur||"",dateSignature:dateSignature||""});
...
export const deleteAffectation=async id=>appeler({action:"deleteAffectation",id});
