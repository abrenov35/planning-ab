...
export const AppProvider=({children})=>{
 ...
 const updateOuvrier=async(id,nom,type,metier,statut,ordre="",separateurApres=false)=>{const r=await api.updateOuvrier(id,nom,type,metier,statut,ordre,separateurApres);if(r.success)await loadData(false);return r;};
